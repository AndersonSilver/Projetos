...
async function jallcard() {
  const codigoRastreio = ticket.payloadOrigin.data.idCartao;
  ...
  const consutaJallCard = async (codigoRastreio) => {
    try {
      ...
      const config = {
        method: "get",
        url: `https://api-portoseg.sensedia.com/pyxis-sp/v1/documentos?codigoPesquisa=FL0000000${codigoRastreio}BR`,
        headers: {
